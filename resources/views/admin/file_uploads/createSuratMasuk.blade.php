                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('file_uploads.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="date">Tanggal Surat Masuk</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="disposition_id" class="form-control" id="">
                                        <option>Pilih Disposition</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="instructions" id="instructions" cols="30" rows="10" class="form-control">{{ old('instructions') }}</textarea>
                                </div>
